    ...
    >
      ...
      >
        ...
        <div className="flex justify-end gap-2">
          <button
            type="button"
            // a11y: move focus INTO the dialog on open (safe default = cancel);
            // without it, focus stays on the trigger and the Esc handler —
            // which lives on the overlay — never receives the keydown.
            autoFocus
