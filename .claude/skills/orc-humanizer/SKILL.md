...
version: 2.7.0
description: |
  Remove signs of AI-generated writing from text, using Wikipedia's "Signs of
  AI writing" pattern catalog. Use when editing or reviewing text to make it
  sound natural and human-written, when the user says a draft "sounds like AI"
  or "reads like slop", or asks to humanize / de-AI a piece of writing.
license: MIT
...
A complete before → draft → still-AI audit → final worked example lives in [`EXAMPLE.md`](./EXAMPLE.md) — read it when unsure how aggressive the rewrite loop should be.
